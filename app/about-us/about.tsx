export default function About() {
  return (
    <main className="w-full bg-[#081533] px-6 md:px-8   ">
      {/* Left Content */}
      ...
      <div className="flex flex-col  items-center md:items-start text-center md:text-left space-y-6 md:w-1/2">
        ...
        <p className="text-white text-sm  lg:tracking-wide md:text-base  md:leading-7 w-full max-w-xl">
         ...
         <button className="border-2 mb-10 w-full md:w-32 flex justify-center text-nowrap  cursor-pointer group relative border-[#0082FF]  overflow-hidden  px-10 py-3 font-semibold rounded-xl  ">
